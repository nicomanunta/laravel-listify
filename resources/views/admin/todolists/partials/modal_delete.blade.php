    ...
    <div class="modal-dialog ">
      <div class="modal-content border-0 bg-modal">
        <div class="modal-header bg-color-purple border-0">
          <h3 class="modal-title  font-archivo color-grey shadow-grey" id="exampleModalLabel">Eliminazione to-do list </h3>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body bg-color-purple border-0">
            <h3 id="costum-message" class="font-archivo color-yellow shadow-yellow">Sei sicuro di voler eliminare la to-do list "{{$todolist->title}}"?</h3>   
        </div>
