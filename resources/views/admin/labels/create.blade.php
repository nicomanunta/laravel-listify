...
<div class="container">
    <div class="row">
        <div class="col-12 mt-4">
          <h1 class="modal-title text-uppercase text-center font-archivo shadow-purple color-yellow ">Crea un'etichetta</h1>
        </div>
              ...
              <div class="form-group my-4">
                ...
                <div class="row justify-content-center ">
                  <div class="form-check form-check-inline col-5 my-2">
                    ...
                    <label class="form-check-label fw-bold " for="label_color_rosso">Rosso <i class="fa-solid fa-square" style="color: #FF0000;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 my-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_rosso_arancione">Rosso-Arancione <i class="fa-solid fa-square" style="color: #FF4500;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_arancione">Arancione <i class="fa-solid fa-square" style="color: #FFA500;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    <input class="form-check-input" type="radio" name="label_color" id="label_color_oro" value="#FFD700" {{ old('label_color') == '#FFD700' ? 'checked' : '' }}>
                    <label class="form-check-label fw-bold" for="label_color_oro">Giallo-Oro <i class="fa-solid fa-square" style="color: #FFD700;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_giallo">Giallo <i class="fa-solid fa-square" style="color: #FFFF00;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_giallo_verdastro">Giallo-Verdastro <i class="fa-solid fa-square" style="color: #ADFF2F;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_verde">Verde <i class="fa-solid fa-square" style="color: #008000;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_verde_acqua">Verde-Acqua <i class="fa-solid fa-square" style="color: #7FFFD4;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_azzurro">Azzurro <i class="fa-solid fa-square" style="color: #00FFFF;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    <input class="form-check-input" type="radio" name="label_color" id="label_color_blu" value="#0000FF" {{ old('label_color') == '#0000FF' ? 'checked' : '' }}>
                    <label class="form-check-label fw-bold" for="label_color_blu">Blu <i class="fa-solid fa-square" style="color: #0000FF;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_indaco">Indaco <i class="fa-solid fa-square" style="color: #4B0082;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_blu_reale">Blu-Reale <i class="fa-solid fa-square" style="color: #8A2BE2;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_viola">Viola <i class="fa-solid fa-square" style="color: #800080;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_marrone">Marrone <i class="fa-solid fa-square" style="color: #A52A2A;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 mb-2">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_grigio">Grigio <i class="fa-solid fa-square" style="color: #808080;"></i></label>
                  </div>
                  <div class="form-check form-check-inline col-5 ">
                    ...
                    <label class="form-check-label fw-bold" for="label_color_rosa">Rosa <i class="fa-solid fa-square" style="color: #FFC0CB;"></i></label>
                  </div>
                </div>
